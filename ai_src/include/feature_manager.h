...
public:
  FeatureManager(const std::string &save_path, int max_size, int topk, int dim,
                 float threshold);
  FeatureManager(const std::string &config_path, const std::string &save_path);
  ~FeatureManager();
